subroutine getmissing(data,npermax,yrbeg,yrend,nens1,nens2,nperyear,y1,y2,nmissing,nn,n0missing,n0,nlength)
!
!   actually get the missing data statistics for the adta
!
    implicit none
    integer npermax,yrbeg,yrend,nens1,nens2,nperyear,y1,y2
    integer nmissing(yrbeg:yrend),nn(yrbeg:yrend),n0missing,n0,nlength(10)
    real data(npermax,yrbeg:yrend,0:nens2)
    integer yr1,yr2,yr,mo,mo1,mo2,m1,m2,nperday,length,iens
    logical doit
