      subroutine calcMAX(fyear,lyear,a,qc,b)
c this routine calculates the maximum and minimum value of the input array a
c
c the procedure is to calculate the max. & min. value of a per month first,
...
c calculate maximum values for the seasons based on monthly values
      call calcMaxSeason(fyear,lyear,c,b)
