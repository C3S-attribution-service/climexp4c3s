subroutine fitgumcov(yrseries,yrcovariate,npernew,fyr,lyr             &
        ...
        ,cov3,offset,t3,tx3,assume,confidenceinterval,biasrt,ndecor              &
...
!
    ...
    real :: yrseries(npernew,fyr:lyr,0:mens),yrcovariate(npernew,fyr:lyr,0:mens), &
        ...
        cov1,cov2,cov3,offset,t3(3,10,3),tx3(3,3),confidenceinterval,biasrt
...
!
    ...
    if ( lopen ) then
        ...
        call write_residuals(yrseries,yrcovariate,npernew,fyr,lyr,mens1,mens,assume, &
            a,b,xi,alpha,beta,lchangesign,ys,ntot,'gumbel')
    end if
!
