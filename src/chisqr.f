...
C     TO GET-FUNCTION-VALUE
  ...
  310 CONTINUE
***      GO TO i99999
      if ( i99.eq.10 ) goto 10
      if ( i99.eq.20 ) goto 20
      if ( i99.eq.90 ) goto 90
      if ( i99.eq.130 ) goto 130
      if ( i99.eq.200 ) goto 200
      if ( i99.eq.270 ) goto 270
      write(0,*) 'dstinv: error: unknown value for i99 ',i99
      call abort
...
***      GO TO i99999
      ...
      if ( i99.eq.20 ) goto 20
      if ( i99.eq.200 ) goto 200
      write(0,*) 'dstzr: error: unknown value for i99 ',i99
      call abort
