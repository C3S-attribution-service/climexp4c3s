subroutine anomalensemble(data,mpermax,nperyear,yrbeg,yrend,yr1,yr2,nens1,nens2)

!   change data to anomalies relative to the ensemble mean

    implicit none
    integer,intent(in) :: mpermax,nperyear,yrbeg,yrend,yr1,yr2,nens1,nens2
    real,intent(inout) :: data(mpermax,yrbeg:yrend,0:nens2)
...
!   sanity check
    ...
    if ( nens2 == nens1 ) then
        write(0,*) 'anomalensemble: cannot take anomalies, no ensemble'
        write(0,*) nens1,nens2
        return
    endif
