...
!
    ...
    real(fgsl_double),allocatable :: ddata1(:),ddata2(:),drs,fac,t,arg1,arg2,arg3,dt,df
!
...
!
    dim = n
    allocate(ddata1(n),ddata2(n))
    ddata1 = data1
    ddata2 = data2
    drs = fgsl_stats_correlation(ddata1,1_fgsl_size_t,ddata2,1_fgsl_size_t,dim)
    deallocate(ddata1,ddata2)
    fac = (1-drs)*(1+drs)
    if ( fac == 0 ) then ! r=±1
        probrs = 0
